...
import org.dkcorp.wikipedia.activities.activities.SearchActivity
...
class ExploreFragment : Fragment() {
    ...
    var resfresher: SwipeRefreshLayout? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        resfresher = view.findViewById<SwipeRefreshLayout>(R.id.refresher)
